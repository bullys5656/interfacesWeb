...
public Articulo(String descripcion,Rubro rubro,double costo,double precio,
int stock,int stock_minimo,int stock_maximo){
...
public Articulo(int id,String descripcion,Rubro rubro,double costo,double precio,
int stock,int stock_minimo,int stock_maximo){
    this.id=id;
    this.descripcion = descripcion;
    this.rubro = rubro;
